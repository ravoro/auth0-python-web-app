# Auth0 Python Web App Sample (without JavaScript)

This sample demonstrates how to add authentication to a Python web app using Auth0.

The sample is based on [00-Starter-Seed](https://github.com/auth0-samples/auth0-python-web-app/tree/master/00-Starter-Seed), with the following differences:
* No use of JavaScript.
* Authenticate with user credentials (user/password) provided through a plain HTML form.
